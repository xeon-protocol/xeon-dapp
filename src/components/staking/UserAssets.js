...
function UserAssets() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:pb-20 px-8 pt-8 max-w-screen-2xl mx-auto text-sm">
      ...
      <div className=" w-full rounded-xl hover:border-animate">
        <div className="flex flex-col h-full">
          <h3 className="text-grey text-2xl md:text-3xl mb-4">Settle</h3>
          <div className="text-grey text-base border-2 py-4 px-2 rounded-md flex-grow">
            <p className="text-center mt-2">
              Close expired positions and collect fees into the staking pool
            </p>
            <div className="flex">
              <button className="m-auto text-white bg-floral mx-auto mt-4  px-8 p-2 rounded-full border-t-none border-b-[1px] border-r-[1px] border-l-[1px] border-button-gradient hover:bg-purple hover:border-lime">
                Settle
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-col h-full">
        <h3 className="text-grey text-2xl md:text-3xl mb-4">$XEON Buyback</h3>
        <div className="text-grey text-base py-4 border-2 p-4 rounded-md flex-grow">
