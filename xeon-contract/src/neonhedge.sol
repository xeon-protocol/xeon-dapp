...
//NEON HEDGE - On-Chain P2P Options and Equity Swaps
//website: www.neonhedge.com
...
contract NeonHedge is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Neon Hedge";
        ...
        )
    {
        ...
        assert(_taxFeeOnBuy + _taxFeeOnSell < _maxFees);
