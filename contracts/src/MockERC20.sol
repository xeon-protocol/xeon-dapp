...
// todo: make this generic to work in a factory model
contract MockERC20 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mock ERC20";
